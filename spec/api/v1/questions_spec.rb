...
describe 'Question API' do
  ...
  describe 'GET /index' do
    ...
    it 'question object content short title' do
  ...
  describe 'POST /create' do
    ...
    context 'valid attributes' do
      ...
      it 'created and saved in db' do
        expect { post api_v1_questions_path, format: :json, access_token: access_token.token,
                      question: attributes_for(:question) }.to change(Question, :count).by(1)

      end

      it 'return status created(201)' do
        post api_v1_questions_path, format: :json, access_token: access_token.token,
